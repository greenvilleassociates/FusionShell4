...
///////// advanced db param - leave blank for default /////////define('SCHLIX_DB_PORT',0); /* if the value is zero then it will use the default port number, usually 3306 for mysql */ 
